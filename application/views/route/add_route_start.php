...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            ...
            <form id="myform" action="<?= base_url('manageroute/savestart') ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    var mymap = L.map('mapid').setView([25.6007, 85.2220], 12);
