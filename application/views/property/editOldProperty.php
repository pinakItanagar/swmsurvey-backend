...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            ...
            <form id="myform" action="<?= base_url('manageproperty/updateproperty') ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Application Number</label>
                                  <input type="text" class="form-control" name="application_no" id="application_no"  disabled="disabled" value="<?php echo $application_no ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="building_type" id="building_type" class="form-control" required>
                                    ...
                                    <option value="1" <?php if($buildingType == 'Residential') {echo "selected=selected";} ?>>Residential</option>
                                    <option value="2" <?php if($buildingType == 'Commercial') {echo "selected=selected";} ?>>Commercial</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>No. of Property</label>
                                  <input type="text" class="form-control" name="no_of_properties" id="no_of_properties" value="<?php echo $no_of_properties ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
