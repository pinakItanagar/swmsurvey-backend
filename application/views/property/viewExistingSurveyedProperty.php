          ...
          $output_image_file = "download/w".$property->ward_no."/property_pic/pic_property_".trim($property->pid).".jpeg";
                    ...
                    <div class="border-top">
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('dashboard/existingproperty/'.$property->ward_no) ?>" class="btn btn-primary" ><< Back to List</a>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    .bindPopup('OWNER NAME : <?=$property->owner_name?><br>PID No : <?=$property->pid?><br>Survey Date/Time : <?=$install_date?> ')
    .openPopup();
