                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="flatName" id="flatName"  value="<?=strtoupper($property->flatName)?>"  >
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Flat No</label>
                                <input type="text" class="form-control" name="flatno"  id="flatno" value="<?=$property->flatno ?>" >
                            </div>
                        </div>
                    ...
                    <div class="border-top">
                        <div class="card-body">
                              <input type="hidden" name="pid" id="pid" value="<?=$property->pid?>" >
