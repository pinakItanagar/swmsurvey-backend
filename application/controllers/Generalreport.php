...
class Generalreport extends CI_Controller {
    ...
    public function allwards() {
        ...
        $pagename = "report/wardlist";
        $wards = $this->tblFootprintReport->getAllVendorWards();
        $title = "Ward report list";
        $data['wards'] = $wards;
    ...
    public function downloadxls($ward_no) {
        ...
        $reports = $this->tblFootprintReport->getWardSurveyRepord($ward_no);
        $spreadsheet = new Spreadsheet(); 
        $xls_sheet_title = "Ward No ".$ward_no." Survey Data";
        $sheet = $spreadsheet->getActiveSheet()->setTitle($xls_sheet_title);
       // Set the value of cell A1 
        ...
        $sheet->setCellValue('E1', "Owner Name");
        
        $spreadsheet->getActiveSheet()->getColumnDimension('F')->setWidth(25);
        $sheet->setCellValue('F1', "Mobile No");
        $sheet->setCellValue('G1', "Property Type");
        
        $spreadsheet->getActiveSheet()->getColumnDimension('H')->setWidth(50);
        $sheet->setCellValue('H1', "Appartment Name");
        ...
        $sheet->setCellValue('J1', "Sector");
        
        $spreadsheet->getActiveSheet()->getColumnDimension('K')->setWidth(25);
        $sheet->setCellValue('K1', "Property Status");
        ...
        $sheet->setCellValue('N1', "GPS Accuracy");
        
        
        $spreadsheet->getActiveSheet()->getColumnDimension('O')->setWidth(20);
        $sheet->setCellValue('O1', "Connecting Road Type");
        
        
        
        $spreadsheet->getActiveSheet()->getColumnDimension('P')->setWidth(20);
        $sheet->setCellValue('P1', "Connecting Road Width");
        
        
        $spreadsheet->getActiveSheet()->getColumnDimension('Q')->setWidth(20);
        $sheet->setCellValue('Q1', "Total Flats");
        
        
        $spreadsheet->getActiveSheet()->getColumnDimension('R')->setWidth(20);
        $sheet->setCellValue('R1', "Total Tanents");
        
        
        
        $spreadsheet->getActiveSheet()->getColumnDimension('S')->setWidth(25);
        $sheet->setCellValue('S1', "Date of Survey");
        ...
        foreach ($reports as $row) {
          ...
          $sheet->setCellValue($cellC, $row->pid);
          $sheet->getStyle($cellC)->applyFromArray($styleArray3); 
          $sheet->getStyle($cellC)->getAlignment()->setHorizontal('left');
          
          $sheet->setCellValue($cellD, $row->qr_code);
          $sheet->getStyle($cellD)->applyFromArray($styleArray3);
          $sheet->getStyle($cellD)->getAlignment()->setHorizontal('left');
          
          $sheet->setCellValue($cellE, $row->owner_name);
          $sheet->getStyle($cellE)->applyFromArray($styleArray3);
          $sheet->getStyle($cellE)->getAlignment()->setHorizontal('left');
          
          $sheet->setCellValue($cellF, $row->mobile_no);
          ...
          $sheet->setCellValue($cellG, $property_type);
          $sheet->getStyle($cellG)->applyFromArray($styleArray3);
          $sheet->getStyle($cellG)->getAlignment()->setHorizontal('left');
          
          
          $sheet->setCellValue($cellH, $row->flatName);
          $sheet->getStyle($cellH)->applyFromArray($styleArray3);
          $sheet->getStyle($cellH)->getAlignment()->setHorizontal('left');
          
          $address = trim($row->houseno." ".$row->address_street);
          
          $sheet->setCellValue($cellI, $address);
          $sheet->getStyle($cellI)->applyFromArray($styleArray3);
          $sheet->getStyle($cellI)->getAlignment()->setHorizontal('left');
          
          
          $sheet->setCellValue($cellJ, $row->sector);
          $sheet->getStyle($cellJ)->applyFromArray($styleArray3);
          $sheet->getStyle($cellJ)->getAlignment()->setHorizontal('left');
          
          $property_status = "";
          if( $row->isnew == "1") {
              $property_status = "NEW PROPERTY";
          } else {
              $property_type = "EXISTING PROPERTY";  
          }
          
          
          $sheet->setCellValue($cellK, $property_status);
          $sheet->getStyle($cellK)->applyFromArray($styleArray3);
          $sheet->getStyle($cellK)->getAlignment()->setHorizontal('left');
          
          
          $sheet->setCellValue($cellL, $row->latitude);
          $sheet->getStyle($cellL)->applyFromArray($styleArray3);
          $sheet->getStyle($cellL)->getAlignment()->setHorizontal('left');
          
          
          $sheet->setCellValue($cellM, $row->longitude);
          $sheet->getStyle($cellM)->applyFromArray($styleArray3);
          $sheet->getStyle($cellM)->getAlignment()->setHorizontal('left');
          
          
          $sheet->setCellValue($cellN, $row->gpsaccuracy);
          $sheet->getStyle($cellN)->applyFromArray($styleArray3);
          $sheet->getStyle($cellN)->getAlignment()->setHorizontal('left');
          
          
          $sheet->setCellValue($cellO, $row->connecting_road_type);
          $sheet->getStyle($cellO)->applyFromArray($styleArray3);
          $sheet->getStyle($cellO)->getAlignment()->setHorizontal('left');
          
          
          $sheet->setCellValue($cellP, $row->connecting_road_width);
          $sheet->getStyle($cellP)->applyFromArray($styleArray3);
          $sheet->getStyle($cellP)->getAlignment()->setHorizontal('left');
          
          
          $sheet->setCellValue($cellQ, $row->total_flats);
          $sheet->getStyle($cellQ)->applyFromArray($styleArray3);
          $sheet->getStyle($cellQ)->getAlignment()->setHorizontal('left');
          
          
          $sheet->setCellValue($cellR, $row->total_tenant_owners);
          $sheet->getStyle($cellR)->applyFromArray($styleArray3);
          $sheet->getStyle($cellR)->getAlignment()->setHorizontal('left');
          
          
           $sheet->setCellValue($cellS, $row->date_updated);
        ...
        $file_name  = 'survey_report_'.date("YmdHis").'.xlsx' ;
