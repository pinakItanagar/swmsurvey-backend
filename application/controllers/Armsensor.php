...
class Armsensor extends CI_Controller {
    ...
    public function vehicles() {
        $data = "";
        $pagename = "armsensor/vehicles";
        $title = "Vehicle type with arm sensor";
    ...
    public function deleteAllJcbData() {
        $payload = '["JCB_SENSOR_DATA" , "RBMN008086"]';
    ...
    public function showAllJcbData($date) {
        ...
        $payload = '["JCB_SENSOR_DATA" , "RBMN008086", "'.$date.'"]';
