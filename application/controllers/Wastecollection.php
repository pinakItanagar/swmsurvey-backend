...
class Wastecollection extends CI_Controller {
    ...
    public function index() {
        ...
        // requestModel[draw]=1&requestModel[columns][0][data]=0&requestModel[columns][0][name]=&requestModel[columns][0][searchable]=true&requestModel[columns][0][orderable]=false&requestModel[columns][0][search][value]=&requestModel[columns][0][search][regex]=false&requestModel[columns][1][data]=UHouseId&requestModel[columns][1][name]=&requestModel[columns][1][searchable]=true&requestModel[columns][1][orderable]=true&requestModel[columns][1][search][value]=&requestModel[columns][1][search][regex]=false&requestModel[columns][2][data]=TStatus&requestModel[columns][2][name]=&requestModel[columns][2][searchable]=true&requestModel[columns][2][orderable]=false&requestModel[columns][2][search][value]=&requestModel[columns][2][search][regex]=false&requestModel[columns][3][data]=OwnerName&requestModel[columns][3][name]=&requestModel[columns][3][searchable]=true&requestModel[columns][3][orderable]=true&requestModel[columns][3][search][value]=&requestModel[columns][3][search][regex]=false&requestModel[columns][4][data]=Address&requestModel[columns][4][name]=&requestModel[columns][4][searchable]=true&requestModel[columns][4][orderable]=true&requestModel[columns][4][search][value]=&requestModel[columns][4][search][regex]=false&requestModel[columns][5][data]=CircleName&requestModel[columns][5][name]=&requestModel[columns][5][searchable]=true&requestModel[columns][5][orderable]=true&requestModel[columns][5][search][value]=&requestModel[columns][5][search][regex]=false&requestModel[columns][6][data]=WardNo&requestModel[columns][6][name]=&requestModel[columns][6][searchable]=true&requestModel[columns][6][orderable]=true&requestModel[columns][6][search][value]=&requestModel[columns][6][search][regex]=false&requestModel[columns][7][data]=OwnerType&requestModel[columns][7][name]=&requestModel[columns][7][searchable]=true&requestModel[columns][7][orderable]=true&requestModel[columns][7][search][value]=&requestModel[columns][7][search][regex]=false&requestModel[columns][8][data]=PropertyType&requestModel[columns][8][name]=&requestModel[columns][8][searchable]=true&requestModel[columns][8][orderable]=true&requestModel[columns][8][search][value]=&requestModel[columns][8][search][regex]=false&requestModel[order][0][column]=0&requestModel[order][0][dir]=asc&requestModel[start]=0&requestModel[length]=10&requestModel[search][value]=&requestModel[search][regex]=false&requestModel[FromDate]=2021-1-25&requestModel[ToDate]=2021-1-25&requestModel[Shift]=1&requestModel[CircleId]=0&requestModel[WardId]=0
        $post = [
            'CircleId' => '1',
            'WardId' => '0',
            'FromDate' => '2021-1-25',
        ...
        $ch = curl_init('http://65.0.84.113:6001/SWMReport/GetWasteCollectionByStatus/');
    ...
    public function report() {
       $url = "http://65.0.84.113:6001/SWMReport/GetWasteCollectionByStatus/requestModel[draw]=1&requestModel[columns][0][data]=0&requestModel[columns][0][name]=&requestModel[columns][0][searchable]=true&requestModel[columns][0][orderable]=false&requestModel[columns][0][search][value]=&requestModel[columns][0][search][regex]=false&requestModel[columns][1][data]=UHouseId&requestModel[columns][1][name]=&requestModel[columns][1][searchable]=true&requestModel[columns][1][orderable]=true&requestModel[columns][1][search][value]=&requestModel[columns][1][search][regex]=false&requestModel[columns][2][data]=TStatus&requestModel[columns][2][name]=&requestModel[columns][2][searchable]=true&requestModel[columns][2][orderable]=false&requestModel[columns][2][search][value]=&requestModel[columns][2][search][regex]=false&requestModel[columns][3][data]=OwnerName&requestModel[columns][3][name]=&requestModel[columns][3][searchable]=true&requestModel[columns][3][orderable]=true&requestModel[columns][3][search][value]=&requestModel[columns][3][search][regex]=false&requestModel[columns][4][data]=Address&requestModel[columns][4][name]=&requestModel[columns][4][searchable]=true&requestModel[columns][4][orderable]=true&requestModel[columns][4][search][value]=&requestModel[columns][4][search][regex]=false&requestModel[columns][5][data]=CircleName&requestModel[columns][5][name]=&requestModel[columns][5][searchable]=true&requestModel[columns][5][orderable]=true&requestModel[columns][5][search][value]=&requestModel[columns][5][search][regex]=false&requestModel[columns][6][data]=WardNo&requestModel[columns][6][name]=&requestModel[columns][6][searchable]=true&requestModel[columns][6][orderable]=true&requestModel[columns][6][search][value]=&requestModel[columns][6][search][regex]=false&requestModel[columns][7][data]=OwnerType&requestModel[columns][7][name]=&requestModel[columns][7][searchable]=true&requestModel[columns][7][orderable]=true&requestModel[columns][7][search][value]=&requestModel[columns][7][search][regex]=false&requestModel[columns][8][data]=PropertyType&requestModel[columns][8][name]=&requestModel[columns][8][searchable]=true&requestModel[columns][8][orderable]=true&requestModel[columns][8][search][value]=&requestModel[columns][8][search][regex]=false&requestModel[order][0][column]=0&requestModel[order][0][dir]=asc&requestModel[start]=0&requestModel[length]=10&requestModel[search][value]=&requestModel[search][regex]=false&requestModel[FromDate]=2021-1-25&requestModel[ToDate]=2021-1-25&requestModel[Shift]=1&requestModel[CircleId]=1&requestModel[WardId]=0" ;
       // $url = "http://65.0.84.113:6001/SWMReport/WasteCltnByStatus?cid=1&wid=0&TId=1&FDate=2021-1-25&TDate=2021-1-25";
       // $url = "http://65.0.84.113:6001/SWMReport/WasteCltnByStatus?cid=1&wid=0&TId=1&FDate=2021-1-25&TDate=2021-1-25";
        $ch = curl_init();
