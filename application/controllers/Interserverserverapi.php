...
class Interserverserverapi extends CI_Controller {
    ...
    public function login() {
        ...
        die();
         ...
         if($resultUSER[0]['userId']) { 
            $user_data = array(
               'app_user_id' => $resultUSER[0]['userId'],
               'app_user_fname' => ucwords(strtolower($resultUSER[0]['first_name'])),
               'app_user_lname' => ucwords(strtolower($resultUSER[0]['last_name'])),
               'app_user_mobile' => $resultUSER[0]['mobile'],
               'app_user_ward_id' => $resultUSER[0]['wardId'],
               'app_user_ward_no' => $resultUSER[0]['ward_no'],
               'app_user_circle_id' => $resultUSER[0]['circle_id'],
               'app_user_circle_name' => $resultUSER[0]['circle_name']             
             );   
           ...
           $response_data = array( 
             ...
             'errorCode' => "FAIL", 
             'responseStatus' => "1",
             'responseMessage' => "User verification failed !"
            );           
        }
    }
